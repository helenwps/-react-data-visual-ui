...
module.exports = options => ({
  ...
  output: Object.assign(
    {
      ...
      path: path.resolve(process.cwd(), 'dip_dist'),
      publicPath: '/'
    },
    options.output
  ...
  plugins: options.plugins.concat([
    ...
    new HappyPack({
      ...
      loaders: [
        ...
        },
        {
          ...
          options: {
            patterns: path.resolve(__dirname, '../../app/assets/less/variable.less')
          }
        }
      ],
      threadPool: happyThreadPool,
    ...
    new CopyWebpackPlugin({
      patterns: [
        { from: "app/assets/images/loginPng", to: "assets/images/loginPng" },

...
module.exports = function addDevMiddlewares(app, webpackConfig) {
  ...
  proxyTarget = 'http://data-visual-ui-front.data-visual.10.74.20.167.nip.io/'
  // proxyTarget = 'http://10.8.4.11:8080/'
  app.use(['/api/v3', '/image', '/file'], proxy({ target: proxyTarget, changeOrigin: true }))
  app.use(middleware)

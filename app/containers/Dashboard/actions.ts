...
export const DashboardActions = {
  ...
  clearShareToken() {
    return {
      type: ActionTypes.CLEAR_SHARE_TOKEN,
      payload: {}
    }
  },
  ...
  changeDashboardTime(frequency: number, dashboardId: number, resolve?: ()=> void) {
    return {
      type: ActionTypes.GOBLE_DASHBOARD_TIME,
      payload: {
        frequency,dashboardId, resolve
      }
    }
  },
  setDashboardTime(frequency: number) {
    return {
      type: ActionTypes.SET_GOBLE_DASHBOARD_TIME,
      payload: {
        frequency
      }
    }
  },
  downloadDashboardFile(dashboardId: number, type: string) {
    return {
      type: ActionTypes.DOWN_DASHBOARD_FILE,
      payload: {
        dashboardId,type
      }
    }
  },
  downloadDashboardFiled() {
    return {
      type: ActionTypes.DOWN_DASHBOARD_FILE_ED,
      payload: {}
    }
  },

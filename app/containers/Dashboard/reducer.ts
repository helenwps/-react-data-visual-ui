  ...
  produce(state, (draft) => {
    ...
    switch (action.type) {
      case VizActionTypes.EDIT_CURRENT_DASHBOARD:
        ...
        break
      case ActionTypes.SET_GOBLE_DASHBOARD_TIME:
      ...
      case ActionTypes.CLEAR_SHARE_TOKEN:
      ...
      case LOCATION_CHANGE:
        ...
        break
      case ActionTypes.DOWN_DASHBOARD_FILE:
        draft.downloadFileIng = true
        break
      case ActionTypes.DOWN_DASHBOARD_FILE_ED:
        draft.downloadFileIng = false
        break
    }
  })

          ...
          if (dimetionAxis === 'row') {
            if (j === rk.length - 1) {
              ...
              if (rk[j] === lastRk[j]) {
                ...
                cellHeight = (propHeight || elementCount * elementSize) * tableSize
                x = 1
                elementCount = 0
            ...
            if (j === rk.length - 1) {
              cellHeight = dimetionAxis === 'col'
                ...
                : maxElementCount === 1
                  ? (propHeight ||getPivotCellHeight(height)) * +tableSize
                  : (propHeight || getPivotCellHeight(maxElementCount * (hasMetricNameDimetion ? 1 : metrics.length) * PIVOT_LINE_HEIGHT)) * +tableSize
          ...
          if (x !== -1) {
            ...
            header.push(
              <th
                ...
                style={{
                  width: (propWidth ||getPivotCellWidth(rowWidths[j])) * +tableSize,

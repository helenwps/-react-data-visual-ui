...
import { spanSize, getPivotCellWidth, getAggregatorLocale, getPivot, getStyleConfig, getPivotCellHeight } from '../util'
          ...
          if (dimetionAxis === 'col') {
            ...
            if (i === cols.length - 2) {
              ...
              if (ck[i] === nextCk[i]) {
                ...
                cellWidth = (propWidth || elementCount * elementSize) * +tableSize
                cellHeight = (propHeight || getPivotCellHeight()) * +tableSize
                x = elementCount
            ...
            if (i === cols.length - 1) {
              cellWidth = dimetionAxis === 'row' ? unitMetricWidth * metrics.length : (propWidth || getPivotCellWidth(width)) * +tableSize
              cellHeight = (propHeight || getPivotCellHeight()) * +tableSize
              tableWidth += cellWidth
            }
            x = spanSize(colKeys, j, i)

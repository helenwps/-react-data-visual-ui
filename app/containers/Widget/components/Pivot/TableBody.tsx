      ...
      if (colKeys.length && rowKeys.length) {
        rowKeys.forEach((rk) => {
          ...
          colKeys.forEach((ck) => {
            ...
            const cellHeight = (chartStyles.pivot.height || getPivotCellHeight(height)) * +chartStyles.pivot.tableSize
            const cellWidth = (chartStyles.pivot.width || getPivotCellWidth(width)) * +chartStyles.pivot.tableSize
        ...
        rowKeys.forEach((rk) => {
          ...
          const cellWidth = (chartStyles.pivot.width || getPivotCellWidth(rowWidths[rowWidths.length - 1])) * +chartStyles.pivot.tableSize
          const cellHeight = (chartStyles.pivot.height || getPivotCellHeight(height)) * +chartStyles.pivot.tableSize
          tableWidth += cellWidth
          line.push(
            <Cell

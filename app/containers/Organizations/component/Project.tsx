...
export const saveEdit = function(props) {
  return <Button type="primary" onClick={props.onModalOk}>保存修改</Button>
}

class ProjectsForm extends React.Component<IProjectsFormProps & FormComponentProps, IProjectsFormStates> {
  constructor (props) {
    super(props)
    this.state = {
      mode: 'role',
  ...
  public componentDidMount() {
    ...
    this.setState({disabled: name !== currentState.name || description !== currentState.description || `${visibility}` !== currentState.visibility})
  }
  ...
  public render () {
    ...
    if (this.state.mode === 'role') {
      mode = <ProjectRole projectDetail={this.props.currentProject} />

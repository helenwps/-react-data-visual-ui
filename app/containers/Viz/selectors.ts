...
const makeSelectPortalsTotal = () =>
  createSelector(
    selectViz,
    (vizState) => vizState.portalsTotal
  )
...
const makeSelectReleaseDashboardIng = () =>
  createSelector(
    selectViz,
    (vizState) => vizState?.loading.releaseing
  )

const makeSelectReleaseModel = () =>
  createSelector(
    selectViz,
    (vizState) => vizState.releaseModel
  )
...
export {
  ...
  makeSelectPortalsTotal,
  makeSelectReleaseDashboardIng,
  makeSelectReleaseModel
}

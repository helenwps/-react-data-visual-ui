...
export const VizActions = {
  loadPortals(projectId: number, page?, pageSize?) {
    return {
  ...
  portalsLoaded(result: {total: number, result: IPortal[] }) {
    return {
  ...
  copyPortal(values, resolve) {
    return {
      type: ActionTypes.COPY_PORTAL,
      payload: {
        values,
        resolve
      }
  ...
  copyFail() {
    return {
      type: ActionTypes.COPY_PORTAL_FAILURE,
      payload: {}
    }
  },
  copySuccess() {
    return {
      type: ActionTypes.COPY_PORTAL_SUCCESS,
      payload: {}
    }
  },
  portalEdited(result) {
  ...
  loadDisplays(projectId: number, page, pageSize) {
    return {
  ...
  dashboardRelease(params, resolve) {
    return {
      type: ActionTypes.RELEASE_DASHBOARD,
      payload: {params, resolve}
    }
  },
  dashboardReleased() {
    return {
      type: ActionTypes.RELEASE_DASHBOARD_SUCCESS,
      payload: {}
    }
  },
  dashboardReleaseFail() {
    return {
      type: ActionTypes.RELEASE_DASHBOARD_FAILURE,
      payload: {}
    }
  },
  addSlide() {
  ...
  getReleaseList(release: number) {
    return {
      type: ActionTypes.RELEASE_GET_LIST,
      payload: {release}
    }
  },
  getReleaseListSuccess(dataList: any) {
    return {
      type: ActionTypes.RELEASE_GET_LIST_SUCCESS,
      payload: {dataList}
    }
  },
  getReleaseListFail() {
    return {
      type: ActionTypes.RELEASE_GET_LIST_Fail,
      payload: {}
    }
  },
  updateReleaseStatus(status: 1 | 2, dataId: number, resolve?) {
    return {
      type: ActionTypes.RELEASE_OFFLINE,
      payload: {status, dataId, resolve}
    }
  },
  updateReleaseStatusSuccess() {
    return {
      type: ActionTypes.RELEASE_OFFLINE_SUCCESS,
      payload: {}
    }
  },
  updateReleaseStatusFail() {
    return {
      type: ActionTypes.RELEASE_GET_LIST_Fail,
      payload: {}
    }

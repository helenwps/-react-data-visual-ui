...
enum Types {
  ...
  CHANGE_LAYER_OPERATION_INFO = 'davinci/Display/CHANGE_LAYER_OPERATION_INFO',
  ...
  CLEAR_LAYERS_OPERATION_INFO = 'davinci/Display/CLEAR_LAYERS_OPERATION_INFO',
  ...
  LOAD_DISPLAY_PASSWORD_SHARE_LINK_SUCCESS = 'davinci/Dashboard/LOAD_DISPLAY_PASSWORD_SHARE_LINK_SUCCESS',
  ...
  CHANGE_TAB = 'davinci/Display/CHANGE_TAB_ACTION'
}

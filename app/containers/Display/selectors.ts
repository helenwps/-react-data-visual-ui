...
const selectCurrentLayers = (state: { display: IDisplayState }) =>
  state.display
    ...
    : {}
const selectCurrentTab = (state: {display: IDisplayState}) => state.display ? state.display.currentTab : initialState.currentTab
...
const makeSelectCurrentSelectedLayerList = () =>
  createSelector(
    ...
    (currentLayerList, currentLayersOperationInfo) =>currentLayerList.filter(
...
const makeSelectCurrentTab = () => 
  createSelector(selectCurrentTab, displayState => {

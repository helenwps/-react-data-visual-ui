...
const Header: React.FC = () => {
  ...
  const loadWidgets = (page, pageSize) => {
    dispatch(WidgetActions.loadWidgets(projectId, page, pageSize))
  }
  const [
    AuthorizedSlide,
    AuthorizedSetting,
    ...
    (type: GraphTypes, subType?: SecondaryGraphTypes) => {
      switch (type) {
        ...
        case GraphTypes.Chart:
          dispatch(WidgetActions.loadWidgets(projectId, 1, 10))
  ...
  const preview = useCallback(() => {
    ...
    console.log(`/project/${projectId}/display/${currentDisplayId}/preview/slide/${slideId}`)

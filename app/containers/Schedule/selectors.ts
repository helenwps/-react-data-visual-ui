...
const makeSelectSchedulesTotal = () => createSelector(
  selectSchedule,
  (scheduleState) => scheduleState.schedulesTotal
)
...
const makeSelectVizs = () => createSelector(
  selectSchedule,
  (scheduleState) => (scheduleState && scheduleState.vizs) || []
)

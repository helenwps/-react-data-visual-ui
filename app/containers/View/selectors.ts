...
const makeSelectSourcesResponse = () => createSelector(
  selectView,
  (viewState: IViewState) => viewState.sourceResponse
)
...
const makeSelectIsLoadingTreeDataIng = () => createSelector(
  selectView,
  (viewState: IViewState) => viewState.isLoadingTreeDataIng
)
...
const makeStatisticsData = () => createSelector(
  selectView,
  (viewState: IViewState) => viewState.statistics
)


const makeSelectEditingSchedule = () => createSelector(
  selectView,
  (viewState: IViewState) => viewState.editingSchedule
)
...
export {
  ...
  makeSelectSources,
  makeSelectSchema,
  makeSelectIsLoadingTreeDataIng,

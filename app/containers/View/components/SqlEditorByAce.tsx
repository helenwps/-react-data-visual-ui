...
import styleGlobal from 'assets/less/style.less'
type TMode =
  | 'sql'
  | 'mysql'
  | 'sqlserver'
...
function SqlEditor(props: ISqlEditorProps) {
  ...
  return (
    <React.Fragment>
      ...
      <div style={{width:'100%', display: 'flex', justifyContent: 'space-between', alignItems:'center', marginBottom: '6px', marginTop: '4px' }}>
        <span className={styleGlobal.textInfo}>
        sql选择数据
          </span>
        <p>
          <Button

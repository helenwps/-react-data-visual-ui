...
enum Types {
  ...
  GET_STATISTICS_DATA = 'davinci/View/GET_STATISTICS_DATA',
  SET_STATISTICS_DATA = 'davinci/View/SET_STATISTICS_DATA',
...
export const SQL_PREVIEW_PAGE_SIZE_OPTIONS = [1,5,10,50,100, 200, 500, 1000]

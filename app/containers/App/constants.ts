...
// 菜单相关开始
export const SHOW_MENU = 'davinci/App/SHOW_MENU'
export const HIDE_MENU = 'davinci/App/HIDE_HIDE_MENU'
export const SET_MENU_ACTIVE = 'davinci/App/SET_MENU_ACTIVE'

export const SHOW_PROJECT_MENU = 'davinci/App/SHOW_PROJECT_MENU'
export const HIDE_PROJECT_MENU = 'davinci/App/HIDE_PROJECT_MENU'
export const SET_PROJECT_MENU_ACTIVE = 'davinci/App/SET_PROJECT_MENU_ACTIVE'
// 菜单相关结束

...
const makeSelectMenuActiveIndex = () =>
  createSelector(
    selectGlobal,
    (globalState) => globalState.menuActiveIndex
  )

const makeSelectMenuIsShow = () =>
  createSelector(
    selectGlobal,
    (globalState) => globalState.isShowMenu
  )

const makeSelectProjectMenuActiveIndex = () =>
  createSelector(
    selectGlobal,
    (globalState) => globalState.projectMenuActiveIndex
  )

const makeSelectProjectMenuIsShow = () =>
  createSelector(
    selectGlobal,
    (globalState) => globalState.isShowProjectMenu
  )
...
export {
  ...
  makeSelectMenuIsShow,
  makeSelectMenuActiveIndex,

...
import {
  ...
  SET_MENU_ACTIVE,
  SHOW_MENU,
  HIDE_MENU, SET_PROJECT_MENU_ACTIVE, SHOW_PROJECT_MENU, HIDE_PROJECT_MENU
} from './constants'
...
export function setMenuActive(index: string) {
  return {
    type: SET_MENU_ACTIVE,
    payload: {menuActiveIndex: index}
  }
}

export function setProjectMenuActive(index: string) {
  return {
    type: SET_PROJECT_MENU_ACTIVE,
    payload: {projectMenuActiveIndex: index}
  }
}

export function showProjectMenu() {
  return {
    type: SHOW_PROJECT_MENU,
    payload: {isShowProjectMenu: true}
  }
}

export function hideProjectMenu() {
  return {
    type: HIDE_PROJECT_MENU,
    payload: {isShowProjectMenu: false}
  }
}
...
export function checkNameUniqueAction(pathname: any, data: any, resolve: any, reject: any) {
  return {
    type: CHECK_NAME,
    payload: {
      pathname,
...
export function updateProfile(id, name,email,phone,workNum,  department, resolve) {
  return {
    type: UPDATE_PROFILE,
    payload: {
      id,

...
import utilStyles from 'app/containers/Profile/profile.less'
import { genColumns } from 'app/utils/genColumns.tsx';
...
export class RoleList extends React.PureComponent {
  ...
  public render() {
    ...
    console.log("ComponentPermission", ComponentPermission)
    ...
    return (
      <div className={utilStyles.roleList}>
        <div className={utilStyles.header}>
          角色配置
        </div>

        <div className={utilStyles.content}>
          <div className={utilStyles.headerSearch}>
            <CreateButton
              type="primary"
              onClick={this.showRoleForm('add')}
              size="small"
            >
              <i className="iconfont" style={{ fontSize: '12px' }}>&#xe712;</i>
            &nbsp;
            新增角色
          </CreateButton>
            <div className={utilStyles.searchInput}>
              <Input.Search
                value={searchValue}
                placeholder="请输入搜索角色"
          ...
          <div className={utilStyles.tableWrap}>
            <Table
              columns={columns}

...
export class LinkageForm extends React.PureComponent<ILinkageFormProps & FormComponentProps, {}> {
  ...
  private checkRepeatAndType = (rule, value, callback) => {
    ...
    console.log(value, linkagerValue, 'type')
    if (value && linkagerValue && value.length && linkagerValue.length) {
      ...
      console.log(triggerSqlType, linkagerSqlType, '12222')
  ...
  public render () {
    ...
    console.log(cascaderSource, 'cascaderSource')
    ...
    console.log(linkagerOptions, 'linkagerOptions')
    return (

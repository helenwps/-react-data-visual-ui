...
export function request (url: string, options?: AxiosRequestConfig): any
export function request (config: AxiosRequestConfig): any
export default function request (url: string | AxiosRequestConfig, options?: AxiosRequestConfig): any {
  const axiosPromise =
